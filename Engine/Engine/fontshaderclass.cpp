...
bool FontShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	// This setup needs to match the VertexType structure in FontClass and in the shader.
	...
	// Release the vertex shader buffer and pixels hader buffer since they are no longer needed.
...
void FontShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, WCHAR* shaderFilename)
{
	...
	// Pop a message up on the screen to notify the user t check the text file for compile errors.
